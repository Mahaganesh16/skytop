    ...
    <script>
         var options = {
            ...
            handler: function (transaction) {
                document.getElementById('razorpay_payment_id').value = "<?php echo $merchant_order_id; ?>";
                document.getElementById('merchant_amount').value;
                document.getElementById('razorpay-form').submit();
            },
            "modal": {
                "ondismiss": function(){
                    window.location.href = "<?php echo base_url('cab_booking')?>";
                }
            }
        };
