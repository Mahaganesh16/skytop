          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                <h3 class="card-title text-uppercase" style="line-height: 2.5em;font-weight: 700;">Testimonials</h3>
				                <span style="float:right;"><a href="<?= base_url('admin/Testimonials/addTestimonial');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Testimonial</a></span>
				            </div>
				            <div class="card-body">		            	
				                  		...
				                  		if(!empty($testimonials)){
						                  	...
						                  	<tr>
							                    ...
							                    <td>
							                    	...
							                    	?>
							                    	<img src="<?= base_url('assets/front_assets/images/testimonials/'.$testimonial->image);?>" width="40px"> 
							                    	<?php
							                    	}else{
							                    	?>
							                    	<img src="<?= base_url('assets/front_assets/images/testimonials/noimage.png');?>" width="40px"> 
							                    	<?php
							                    	}
							                    	?>
							                    </td>
							                    ...
							                    <td><?php echo $testimonial->company;?>
							                    </td>
							                    <td>
							                    	<?php
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Testimonials/editTestimonial/'.$testimonial->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Testimonials/deleteTestimonial/'.$testimonial->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
