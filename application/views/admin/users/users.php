          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                <h3 class="card-title text-uppercase" style="line-height: 2.5em;font-weight: 700;">Workers</h3>
				                <span style="float:right;"><a href="<?= base_url('admin/Worker/addWorker');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Worker</a></span>
				            </div>
				            <div class="card-body">		            	
				                <table id="Workers" class="table table-bordered table-striped">
				                  	<thead>
					                  	<tr>
						                    <th>Id</th>
						                    <th>Name</th>
				                  		...
				                  		if(!empty($worker)){
						                  	...
						                  	<tr>
							                    ...
							                    <td>
							                    	...
							                    	?>
							                    	<img src="<?= base_url('assets/front/images/profile/'.$row->profile);?>" width="80px"> 
							                    	<?php
							                    	}else{
							                    	?>
							                    	<img src="<?= base_url('assets/front_assets/images/Workers/noimage.png');?>" width="80px"> 
							                    	<?php
							                    	}
							                    	?>
							                    </td>
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Worker/editWorker/'.$row->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Worker/deleteWorker/'.$row->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
