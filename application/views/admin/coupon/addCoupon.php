    			...
    			<div class="row">
					...
					<div class="col-md-12">  
			            <div class="card card-primary">
				            ...
				            <form role="form" method="POST" action="<?= base_url('admin/Coupons/addCoupon');?>"  enctype="multipart/form-data">
				                <div class="card-body">
				                  	<div class="row">
				                  		<div class="col-md-5">
				                  			...
				                  			<div class="form-group">
				                  				...
				                  				<input type="text" name="validity" id="validity" class="form-control"placeholder="Number of Days">
