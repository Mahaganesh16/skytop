          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                <h3 class="card-title text-uppercase" style="line-height: 2.5em;font-weight: 700;">Cars</h3>
				                <span style="float:right;"><a href="<?= base_url('admin/Cars/addCars');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Cars</a></span>
				            </div>
				            <div class="card-body">		            	
				                  		...
				                  		if(!empty($cars)){
						                  	...
						                  	<tr>
							                    ...
							                    <td>
							                    	...
							                    	if($all_cars->category > 0){
								                    	$categoryDet = $CI->AdminDashboard_Model->getCategoryDet($all_cars->category);
								                    	
								                    	echo $categoryDet->category_name;
							                    ...
							                    <td><?php echo $all_cars->car_name;?></td>
							                    <td>
							                    	<?php
							                    	if(!empty($all_cars->image)){
							                    	?>
							                    	<img src="<?= base_url('assets/images/car_image/'.$all_cars->image);?>" width="80px"> 
							                    	<?php
							                    	}else{
							                    	?>
							                    	<img src="<?= base_url('assets/front_assets/images/categories/noimage.png');?>" width="80px"> 
							                    	<?php
							                    	}
							                    	?>
							                    </td>
							                    <td>
							                    	<?php echo $all_cars->car_seats;?>
							                    </td>
							                      <td>
							                    	<?php echo $all_cars->ac_or_non_ac;?>
							                    </td>
							                      <td>
							                    	<?php echo $all_cars->luggage;?>
							                    </td>
							                    
							                    <td>
							                    	<?php 
							                    	if($all_cars->status == 1){
							                    		?>
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Category/editCategory/'.$all_cars->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Category/deleteCategory/'.$all_cars->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
