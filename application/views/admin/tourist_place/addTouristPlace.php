...
<html>
<head>
	<title>Add Tourist Place | Admin</title>
	<meta charset="utf-8">
  	...
  	<div class="content-wrapper">
  		<div class="content-header">
	      	<div class="container-fluid">
		        <div class="row mb-2">
			        <div class="col-sm-6">
			            <h1 class="m-0 text-dark">Add Tourist Place</h1>
			        </div>
			        <div class="col-sm-6">
			            <ol class="breadcrumb float-sm-right">
			              <li class="breadcrumb-item"><a href="<?= base_url('admin/Dashboard');?>">Dashboard</a></li>
			              <li class="breadcrumb-item"><a href="<?= base_url('admin/Category');?>">Tourist Place</a></li>
			              <li class="breadcrumb-item active">Add Tourist Place</li>
			            </ol>
			        </div>
		        </div>
	      	</div>
					...
					<div class="col-md-7">  
			            <div class="card card-primary">
				            <div class="card-header">
				                <h3 class="card-title">Add Tourist Place</h3>
				            </div>
				            <form role="form" method="POST" action="<?= base_url('admin/Tourist_Place/addTourist_Place');?>"  enctype="multipart/form-data">
				                <div class="card-body">
				                  	<div class="row">
				                  			...
				                  			<div class="form-group col-md-6">
				                  				...
				                  				<input type="text" name="tourist_place" id="tourist_place" class="form-control"placeholder="Enter Tourist Place">
				                ...
				                <div class="card-footer">
				                  	<button type="submit" class="btn btn-primary">Add Tourist Place</button>
				                </div>
				            </form>
			            </div>
				    </div>
