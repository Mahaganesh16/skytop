...
<html>
<head>
	<title>Tourist Place | Admin</title>
	<meta charset="utf-8">
  	...
  	<div class="content-wrapper">
  		<div class="content-header">
	      	<div class="container-fluid">
		        <div class="row mb-2">
			        <div class="col-sm-6">
			            <h1 class="m-0 text-dark">Tourist Place</h1>
			        </div>
			        <div class="col-sm-6">
			            <ol class="breadcrumb float-sm-right">
			              <li class="breadcrumb-item"><a href="<?= base_url('admin/Dashboard');?>">Dashboard</a></li>
			              <li class="breadcrumb-item active">Tourist Place</li>
			            </ol>
			        </div>
		        </div>
	      	</div>
          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                <h3 class="card-title text-uppercase" style="line-height: 2.5em;font-weight: 700;">Tourist Place</h3>
				                <span style="float:right;"><a href="<?= base_url('admin/Tourist_Place/addTourist_Place');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Tourist Place</a></span>
				            </div>
				            <div class="card-body">		            	
				                <table id="categories" class="table table-bordered table-striped">
				                  	...
				                  	<tbody>
				                  		<?php
				                  		if(!empty($tourist_place)){
				                  			$count = 1;
					                  		foreach ($tourist_place as $place) 
					                  		{
					                  		?>
						                  	<tr>
							                    ...
							                    <td><?php echo $place->district;?></td>
							                    <td>
							                    	<?php
							                    	if(!empty($place->image)){
							                    	?>
							                    	<img src="<?= base_url('assets/images/tourist_place/'.$place->image);?>" width="80px"> 
							                    	<?php
							                    	}else{
							                    	?>
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Tourist_Place/editTourist_Place/'.$place->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Tourist_Place/deleteTourist_Place/'.$place->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
