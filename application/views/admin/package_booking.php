...
<html>
<head>
	<title>Package Booking | Admin</title>
	<meta charset="utf-8">
...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<?php include APPPATH.'views/admin/includes/sidebar.php';?>
  	<div class="content-wrapper">
  		<div class="content-header">
	      	<div class="container-fluid">
		        <div class="row mb-2">
			        <div class="col-sm-6">
			            <h1 class="m-0 text-dark">Package Booking</h1>
			        </div>
			        <div class="col-sm-6">
				                  	...
				                  	<tbody>
				                  		...
				                  		if(!empty($booking)){
						                  	...
						                  	<tr>
							                    ...
							                    <td>
							                    	<?php echo $bookings->cid;?>
							                    </td>
							                    <td>
							                    	<?php echo $bookings->package_name;?>
							                    </td>
							                     <td>
							                    	<?php echo $bookings->mobile_no;?>
							                    </td>
							                     <td>
							                    	<?php echo $bookings->travel_date;?>
							                    </td>
							                     <td>
							                    	<?php echo substr($bookings->address, 0,200) ;?>
							                    </td>
						                  	...
						                  	<div class="modal fade" id="book1_<?php echo $bookings->id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
											    ...
											    <div class="modal-content">
											      ...
											      <div class="modal-body">
											      	<form action="<?php echo base_url('admin/Dashboard/assign_job_package/'.$bookings->id)?>" method="post">
  	...
  	<?php
  		...
  		{
  		?>
  	 <div class="modal fade bd-example-modal-lg" id="book_<?php echo $bookings->id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
           ...
           <div class="text-center"> 
            ...
            <!-- <div class="text-center"> -->
            	<table class="table" align="center">
            		<tr>
	  				<td>Name :</td><td><?php  echo $bookings->name;?>	</td></tr>
	  				
	  				<tr><td> Mobile No :</td><td><?php  echo $bookings->mobile_no;?></td></tr>
	  				<tr><td>Pickup Address:</td><td><?php  echo $bookings->address;?></td></tr>
