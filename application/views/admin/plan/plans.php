          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                ...
				                <span style="float:right;"><a href="<?= base_url('admin/Plan/addPlan');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Plan</a></span>
				            </div>
				            <div class="card-body">		            	
				                  	...
				                  	<tbody>
				                  		...
				                  		if(!empty($plans)){
						                  	...
						                  	<tr>
							                    ...
							                    <td><?php echo $plan->plan_name;?>
							                    </td>
							                    <td><?php echo $plan->validity;?>
							                    </td>
							                    <td>
							                    	<?php 
							                    	if($plan->status == 1){
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Plan/editPlan/'.$plan->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Plan/deletePlan/'.$plan->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
