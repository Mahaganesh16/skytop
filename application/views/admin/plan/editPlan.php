					...
					<div class="col-md-12">  				
	          			<div class="col-md-6">
				            <div class="card card-primary">
					            ...
					            <form role="form" method="POST" action="<?= base_url('admin/Plan/editPlan/'.$planDet->id);?>">
					                <div class="card-body">
					                  	<div class="form-group">
					                    	<label>Plan Name</label>
					                    	<input type="text" class="form-control" id="plan_name" name="plan_name" placeholder="Plan Name" value="<?php echo $planDet->plan_name;?>">
					                    	<?php echo form_error('plan_name',"<div style='color:red'>","</div>");?>
						                </div>
						                <div class="form-group row">
						                	<?php
						                		if(!empty($planDet->validity)){
						                			$validity = explode('-', $planDet->validity);
						                		}else{
						                			$validity = '';
						                		}
						                	?>
						                	<div class="col-md-6">
						                    	...
						                    	<input type="number" class="form-control" id="validity" name="validity" placeholder="Number of Days/Week/Months/Year" value="<?php if(!empty($validity)) echo $validity[0];?>">
						                    ...
						                    <div class="col-md-6">
						                    	...
						                    	<select class="form-control" required name="validity1" id="validity1">
						                    		...
						                    		<option value="Day" <?php if(!empty($validity) && $validity[1] == 'Day') echo "selected";?>>Day</option>
						                    		<option value="Weekly" <?php if(!empty($validity) && $validity[1] == 'Weekly') echo "selected";?>>Weekly</option>
						                    		<option value="Monthly" <?php if(!empty($validity) && $validity[1] == 'Monthly') echo "selected";?>>Monthly</option>
						                    		<option value="Yearly" <?php if(!empty($validity) && $validity[1] == 'Yearly') echo "selected";?>>Yearly</option>
						                    	</select>
						                    </div>
					                  	</div>
					                  	<div class="form-group">
					                    	<label>Amount</label>
					                    	<input type="text" class="form-control" id="amount" name="amount" placeholder="Plan Amount" value="<?php echo $planDet->amount;?>">
					                    	<?php echo form_error('amount',"<div style='color:red'>","</div>");?>
						                </div>
					                  	<div class="form-group">
					                    	<label>Description</label>
					                    	<textarea class="form-control" id="description" name="description" placeholder="Description"><?php echo $planDet->description;?></textarea>
					                  	...
					                  	<div class="form-group">
					                    	...
					                    	<select class="form-control" id="status" name="status">
					                    		<option value="">Select</option>
					                    		<option value="1" <?php if($planDet->status == '1') echo "selected";?>>Active</option>
					                    		<option value="0" <?php if($planDet->status == '0') echo "selected";?>>In Active</option>
					                    	</select> 
