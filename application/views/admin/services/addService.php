    			...
    			<div class="row">
					...
					<div class="col-md-12">  
			            <div class="card card-primary">
				            ...
				            <form role="form" method="POST" action="<?= base_url('admin/Pages/addPage');?>" enctype="multipart/form-data">
				                <div class="card-body">
				                	<div class="row">
				                		<div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                	<div class="form-group">
						                		...
						                		<textarea class="textarea form-control" name="page_content" id="page_content" placeholder="Page Content"></textarea>
