	          			...
	          			<div class="col-lg-6 col-6">
	            			<div class="small-box bg-info">
	              				<div class="inner">
	                				...
	                				<p><i class="fas fa-rupee-sign"></i> <?php echo $plan->amount;?></p>
	              				</div>
					            <div class="icon">
					                <i class="	fas fa-rupee-sign"></i>
					            </div>
	              				<a href="<?= base_url('admin/Seller/sellerByPlan/'.$plan->id);?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
	            			</div>
	          			</div>
    					<?php
    					}
