          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                ...
				                <span style="float:right;"><a href="<?= base_url('admin/Slider/addSlider');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Slider</a></span>
				            </div>
				            <div class="card-body">		            	
				                  		...
				                  		if(!empty($slider)){
						                  	...
						                  	<tr>
							                    ...
							                    <td>
							                    	...
							                    	?>
							                    	<img src="<?= base_url('assets/website/images/slider/'.$sliders->image);?>" width="80px"> 
							                    	<?php
							                    	}else{
							                    	?>
							                    	<img src="<?= base_url('assets/website/images/slider/noimage.png');?>" width="80px"> 
							                    	<?php
							                    	}
							                    	?>
							                    </td>
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Slider/editSlider/'.$sliders->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Slider/deleteSlider/'.$sliders->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
