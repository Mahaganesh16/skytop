          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                <h3 class="card-title text-uppercase" style="line-height: 2.5em;font-weight: 700;">Email Templates</h3>
				                <span style="float:right;"><a href="<?= base_url('admin/EmailTemplate/addTemplate');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Email Templates</a></span>
				            </div>
				            <div class="card-body">		            	
				                <table id="emailtemplate" class="table table-bordered table-striped">
				                  	<thead>
					                  	<tr>
						                    <th>Id</th>
						                    <th>Name</th>
				                  		...
				                  		if(!empty($template)){
						                  	...
						                  	<tr>
							                    <td><?php echo $count;?></td>
							                  	...
							                  	<td><?php echo $templates->template_name;?>
							                    </td>
							                     <td>
							                    	<?php echo $templates->slug;?>
							                    </td>
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Testimonials/editTestimonial/'.$templates->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Testimonials/deleteTestimonial/'.$templates->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
