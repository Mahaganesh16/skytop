    			...
    			<div class="row">
					...
					<div class="col-md-12">  
			            <div class="card card-primary">
				            ...
				            <form role="form" method="POST" action="<?= base_url('admin/Advertisements/editAd/'.$adDet->id.'/'.$sellerDet->id);?>"  enctype="multipart/form-data">
				                <div class="card-body">
				                  	<div class="row">
				                  		<div class="col-md-5">
				                  			<div class="form-group">
		                                        ...
		                                        if(!empty($mainCategories)){
		                                            foreach ($mainCategories as $cat) {
		                                                ?>
		                                                <option value="<?php echo $cat->id;?>" <?php if($cat->id == $adDet->category) echo "selected"; ?>><?php echo $cat->category_name;?></option>
		                                                <?php
		                                            }
		                                        }
		                                        ?>
				                  			...
				                  			<div class="form-group">
				                  				<label>Ad Name</label>
				                  				<input type="text" name="ad_name" id="ad_name" class="form-control"placeholder="Enter Name" value="<?php echo $adDet->ad_name;?>">
				                  			...
				                  			<div class="form-group">
				                  				...
				                  				<select name="ad_validity" id="ad_validity" class="form-control selectbox">
				                  					...
				                  					$sellerDet = $this->AdminDashboard_Model->getSellerDet($adDet->seller_id);
				                  					$planDet = $this->AdminDashboard_Model->getPlanDet($sellerDet->plan);
				                  					if($planDet->id == '2'){
				                  					?>
				                  					<option value="permanent" <?php if($adDet->ad_validity == 'permanent') echo "selected";?>>Permanent Validity</option>
				                  					<?php
				                  					}
				                  					?>
				                  					...
				                  					for ($i=1; $i <= 31; $i++) { 
				                  						?>
				                  						<option value="<?php echo $i;?>" <?php if($adDet->ad_validity == $i) echo "selected";?>><?php echo $i." Day"?></option>
				                  						<?php
				                  					}
				                  					?>
				                  				</select>
				                  			...
				                  			<div class="form-group">
				                  				...
				                  				?><Br>
				                  				<img src="<?= base_url('assets/front_assets/images/ads/'.$adDet->image);?>" width="100px">
				                  				|
				                  				<a href="<?= base_url('admin/Advertisements/deleteAdImage/'.$adDet->id.'/'.$sellerDet->id);?>"><i class="fa fa-trash"></i> Delete</a>
				                  				<?php
				                  				}
				                  				?>
				                  			...
				                  			<div class="form-group">
				                  				...
				                  				<select class="form-control" name="status" id="status">
				                  					...
				                  					<option value="1" <?php if($adDet->status == '1') echo "selected";?>>Active</option>
				                  					<option value="0" <?php if($adDet->status == '0') echo "selected";?>>In Active</option>
				                  				</select>
				                  		...
				                  		<div class="col-md-7">
				                  			<div class="form-group">
				                  				...
				                  				<input type="text" name="coupon_name" id="coupon_name" class="form-control"  value="<?php echo $adDet->coupon_name;?>"placeholder="Coupon Name">
				                  			...
				                  			<div class="form-group">
				                  				...
				                  				<input type="text" name="percentage" id="percentage" class="form-control" value="<?php echo $adDet->percentage;?>"placeholder="Enter Percentage">
				                  				<?php echo form_error('percentage',"<div style='color:red'>","</div>");?>
				                  			</div>
				                  			<div class="form-group">
				                  				<label>Validity</label>
				                  				<input type="text" name="validity" id="validity" class="form-control" value="<?php echo $adDet->validity;?>"placeholder="Number of Days" readonly>
				                  				<?php echo form_error('validity',"<div style='color:red'>","</div>");?>
				                  			</div>
				                  			<div class="col-md-12">
					                  			<div class="form-group">
					                  				<label>Address</label>
					                  				<textarea class="form-control" name="address" id="address" placeholder="Address" value="<?php echo $adDet->address;?>"rows="6"><?php echo $adDet->address;?></textarea>
					                  				<?php echo form_error('address',"<div style='color:red'>","</div>");?>
					                  			</div>
					                  		</div>
				                  			<div class="form-group">
				                  				<label>Description</label>
				                  				<textarea class="form-control textarea" name="description" id="description" placeholder="Description" rows="6"><?php echo htmlspecialchars_decode($adDet->ad_description);?></textarea>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$('#mainCategory').change(function(){
				...
				$.ajax({
		            type: "POST",
		            url  : "<?php echo site_url(); ?>/admin/Advertisements/getSubCategory",
