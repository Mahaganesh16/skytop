          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                ...
				                <span style="float:right;"><a href="<?= base_url('admin/SubAdmin/addSubAdmin');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Sub Admin</a></span>
				            </div>
				            <div class="card-body">		            	
				                  		...
				                  		if(!empty($admins)){
						                  	...
						                  	<tr>
							                    ...
							                    <td>
							                    	...
							                    	?>
							                    	<img src="<?= base_url('assets/front_assets/images/profile/admins/'.$admin->image);?>" width="50px"> 
							                    	<?php
							                    	}else{
							                    	?>
							                    	<img src="<?= base_url('assets/front_assets/images/profile/adminicon.png');?>" width="50px"> 
							                    	<?php
							                    	}
							                    	?>
							                    </td>
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/SubAdmin/deleteSubAdmin/'.$admin->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
