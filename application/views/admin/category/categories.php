          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                <h3 class="card-title text-uppercase" style="line-height: 2.5em;font-weight: 700;">Categories</h3>
				                <span style="float:right;"><a href="<?= base_url('admin/Category/addCategory');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Category</a></span>
				            </div>
				            <div class="card-body">		            	
						                  	...
						                  	<tr>
							                    ...
							                    <td>
							                    	...
							                    	if($category->parent > 0){
								                    	$categoryDet = $CI->AdminDashboard_Model->getCategoryDet($category->parent);
							                    ...
							                    <td>
							                    	...
							                    	?>
							                    	<img src="<?= base_url('assets/front_assets/images/categories/'.$category->image);?>" width="80px"> 
							                    	<?php
							                    	}else{
							                    	?>
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Category/editCategory/'.$category->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Category/deleteCategory/'.$category->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
