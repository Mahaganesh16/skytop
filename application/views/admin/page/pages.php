          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                <h3 class="card-title text-uppercase" style="line-height: 2.5em;font-weight: 700;">Pages</h3>
				                <span style="float:right;"><a href="<?= base_url('admin/Pages/addPage');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Page</a></span>
				            </div>
				            <div class="card-body">		            	
				                  	...
				                  	<tbody>
				                  		...
				                  		if(!empty($pages)){
						                  	...
						                  	<tr>
							                    ...
							                    <td><?php echo $page->slug;?>
							                    </td>
							                    <td>
							                    	<?php 
							                    	if(!empty($page->banner)){
							                    	?>
							                    	<img src="<?= base_url('assets/front_assets/images/page_banners/'.$page->banner);?>" width="180px">
							                    	<?php
							                    	}?>
							                    </td>
							                    <td>
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Pages/editPage/'.$page->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Pages/deletePage/'.$page->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
