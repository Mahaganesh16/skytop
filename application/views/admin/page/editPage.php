    			...
    			<div class="row">
					...
					<div class="col-md-12">  
			            <div class="card card-primary">
				            ...
				            <form role="form" method="POST" action="<?= base_url('admin/Pages/editPage/'.$pageDetail->id);?>" enctype="multipart/form-data">
				                <div class="card-body">
				                	<div class="row">
				                		<div class="col-md-4">
						                  	<div class="form-group">
						                    	<label>Page Name</label>
						                    	<input type="text" class="form-control" id="page_name" name="page_name" placeholder="Page Name" value="<?php echo $pageDetail->page_name;?>">
						                    	<?php echo form_error('page_name',"<div style='color:red'>","</div>");?>
						                  	</div>
						                  	<div class="form-group">
						                    	<label>Slug</label>
						                    	<input type="text" class="form-control" id="slug" name="slug" placeholder="Slug" readonly value="<?php echo $pageDetail->slug;?>">
						                    	<?php echo form_error('slug',"<div style='color:red'>","</div>");?>
						                  	</div>
						                  	<div class="form-group">
						                    	<label>Banner Image</label>
						                    	<input type="file" class="form-control" id="banner" name="banner" onchange="return fileValidation()">
						                    	...
						                    	<?php
													...
													?>
													<br>
													<img src="<?= base_url('assets/front_assets/images/page_banners/'.$pageDetail->banner);?>" width="100px">
													|
													<a href="<?= base_url('admin/Pages/deleteBannerImage/'.$pageDetail->id);?>"><i class="fa fa-trash"></i> Delete</a>
													<?php		
						                    		}
						                    	?>
						                  	</div>
						                  	<div class="form-group">
						                    	...
						                    	<select class="form-control" id="status" name="status">
						                    		...
						                    		<option value="1"<?php if($pageDetail->status == '1') echo "selected";?>>Active</option>
						                    		<option value="0"<?php if($pageDetail->status == '0') echo "selected";?>>In Active</option>
						                    	</select>
						                ...
						                <div class="col-md-8">
						                	<div class="form-group">
						                		...
						                		<textarea class="textarea form-control" name="page_content" id="page_content" placeholder="Page Content"><?php echo htmlspecialchars_decode($pageDetail->page_content);?></textarea>
