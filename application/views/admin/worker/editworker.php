...
<html>
<head>
	<title><?php echo $WorkerDet->name;?> | Worker | Admin</title>
	<meta charset="utf-8">
  	...
  	<div class="content-wrapper">
  		<div class="content-header">
	      	<div class="container-fluid">
		        <div class="row mb-2">
			        <div class="col-sm-6">
			            <h1 class="m-0 text-dark">Add Worker</h1>
			        </div>
			        <div class="col-sm-6">
			            <ol class="breadcrumb float-sm-right">
			              <li class="breadcrumb-item"><a href="<?= base_url('admin/Dashboard');?>">Dashboard</a></li>
			              <li class="breadcrumb-item"><a href="<?= base_url('admin/Worker');?>">Worker</a></li>
			              <li class="breadcrumb-item active"><?php echo $WorkerDet->name;?> 's Edit</li>
			            </ol>
			        </div>
		        </div>
	      	</div>
    			...
    			<div class="row">
					...
					<div class="col-md-12">  
			            <div class="card card-primary">
				            ...
				            <form role="form" method="POST" action="<?= base_url('admin/Worker/editWorker/'.$WorkerDet->id);?>"  enctype="multipart/form-data">
				                <div class="card-body">
				                  	<div class="row">
				                  		
				                  			<div class="form-group col-md-4">
				                  				<label>Name</label>
				                  				<input type="text" name="name" id="name" class="form-control" placeholder="Enter Your Name" value="<?php echo $WorkerDet->name;?>">
				                  				<?php echo form_error('name',"<div style='color:red'>","</div>");?>
				                  			</div>
				                  			<div class="form-group col-md-4">
				                  				<label>Mobile Number</label>
				                  				<input type="text" name="mobile" id="mobile" class="form-control" placeholder="Enter Your Name" value="<?php echo $WorkerDet->mobile;?>">
				                  				<?php echo form_error('mobile',"<div style='color:red'>","</div>");?>
				                  			</div>
				                  			<div class="form-group col-md-4">
				                  				<label>Email</label>
				                  				<input type="email" name="email" id="email" class="form-control" placeholder="Enter Your Name" value="<?php echo $WorkerDet->email;?>">
				                  				<?php echo form_error('email',"<div style='color:red'>","</div>");?>
				                  			</div>
				                  		
				                  			<div class="form-group col-md-6">
				                  				<label>Password</label>
				                  				<input type="password" name="password" id="password" class="form-control" placeholder="Enter Your Name" value="<?php echo $WorkerDet->password;?>">
				                  				<?php echo form_error('password',"<div style='color:red'>","</div>");?>
				                  			</div>
				                  			<div class="form-group col-md-6">
				                  				<label>Confirm Password</label>
				                  				<input type="password" name="cpassword" id="cpassword" class="form-control" placeholder="Enter Your Name" value="<?php echo $WorkerDet->password;?>">
				                  			...
				                  			<div class="form-group col-md-6">
				                  				...
				                  				<select class="form-control" name="work" id="work">
				                  					...
				                  					<option value="<?php echo $WorkerDet->work?>"<?php echo "selected";?> ><?php echo $WorkerDet->work?></option>
				                  					<?php 
				                  			...
				                  			<div class="form-group col-md-6">
				                  				...
				                  				<select class="form-control" name="working_status" id="working_status">
				                  					<option value="">Select</option>
				                  					<option value="1"  <?php if($WorkerDet->working_status == '1') echo "selected";?>>Active</option>
				                  					<option value="0"  <?php if($WorkerDet->working_status == '0') echo "selected";?>>In Active</option>
				                  				</select>
				                  				<?php echo form_error('working_status',"<div style='color:red'>","</div>");?>
				                  			</div>
				                  			<div class="form-group col-md-6">
				                  				<label>Status</label>
				                  				<select class="form-control" name="status" id="status">
				                  					<option value="">Select</option>
				                  					<option value="1"  <?php if($WorkerDet->status == '1') echo "selected";?>>Active</option>
				                  					<option value="0"  <?php if($WorkerDet->status == '0') echo "selected";?>>In Active</option>
				                  				</select>
				                  				<?php echo form_error('status',"<div style='color:red'>","</div>");?>
				                  			</div>
				                  			<div class="form-group  col-md-6">
				                  				<label>Description</label>
				                  				<textarea class="form-control textarea" name="description" id="description" placeholder="Description" rows="6" value="<?php echo $WorkerDet->description;?>"><?php echo $WorkerDet->description;?></textarea>
				                  				<?php echo form_error('description',"<div style='color:red'>","</div>");?>
				                  			</div>
				                  			<div class="form-group col-md-6">
				                  				<label>Address</label>
				                  				<textarea class="form-control textarea" name="address" id="address" placeholder="Description" rows="6" value="<?php echo $WorkerDet->address;?>"><?php echo $WorkerDet->address;?></textarea>
