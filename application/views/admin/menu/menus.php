          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                <h3 class="card-title text-uppercase" style="line-height: 2.5em;font-weight: 700;">Menus</h3>
				                <span style="float:right;"><a href="<?= base_url('admin/Menus/addMenu');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Menu</a></span>
				            </div>
				            <div class="card-body">		            	
				                  	...
				                  	<tbody>
				                  		...
				                  		if(!empty($menus)){
						                  	...
						                  	<tr>
							                    ...
							                    <td>
							                    	...
							                    	if($menu->parent == '0'){
							                    		echo "Main Menu";
							                         	...
							                         	$parent= $CI->AdminDashboard_Model->getMenuDetail($menu->parent);  
								                        echo $parent->menu;
							                    	}
							                    	?>
							                    </td>
							                    <td><?php echo $menu->menu;?>
							                    </td>
							                    <td><?php echo $menu->slug;?>
							                    </td>
							                    <td>
							                    	<?php 
							                    	if($menu->status == 1){
							                    ...
							                    <td>
							                    	<a href="<?= base_url('admin/Menus/editMenu/'.$menu->id);?>" target="_blank"><i class="fa fa-edit"></i></a>
							                    	|
							                    	<a href="<?= base_url('admin/Menus/deleteMenu/'.$menu->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
