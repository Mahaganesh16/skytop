          			...
          			<div class="col-md-12">
          				<div class="card">
				            <div class="card-header">
				                <h3 class="card-title text-uppercase" style="line-height: 2.5em;font-weight: 700;">Themes</h3>
				                <span style="float:right;"><a href="<?= base_url('admin/Themes/addTheme');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Theme</a></span>
				            </div>
				            <div class="card-body">		            	
				                  	...
				                  	<tbody>
				                  		...
				                  		if(!empty($themes)){
						                  	...
						                  	<tr>
							                    ...
							                    <td>
							                    	<?php
							                    	$folder_name = explode('.', $theme->theme_files)
							                    	?>
							                    	<a href="<?= base_url('assets/builder_assets/themes/'.$folder_name[0]);?>" target="_blank"><i class="fa fa-eye"></i> Preview</a>
							                    	|
							                    	<a href="<?= base_url('admin/Themes/deleteTheme/'.$theme->id);?>"><i class="fa fa-trash"></i></a>
							                    </td>
						                  	</tr>
						                <?php 
						            		$count++;
