...
class EmailTemplate extends CI_Controller {
	...
	public function index()
	{
		...
		$template = $this->AdminDashboard_Model->getAllTemplate();
		$this->load->view('admin/Email/email', ['adminDetails' => $adminDetails,'template' => $template]);
	}
	public function addTemplate()
	{
        ...
        if ($this->form_validation->run()){
	        ...
	        $insertResult = $this->AdminDashboard_Model->insertTemplate($insertData);
	        if($insertResult){
	        	$this->session->set_flashdata('success_message','Template added successfully');
	        	return redirect('admin/EmailTemplate',['adminDetails' => $adminDetails, 'template' => $template]);
	        }else{
	        	$this->session->set_flashdata('error_message','Template not added. Try again later');
	        	return redirect('admin/EmailTemplate',['adminDetails' => $adminDetails, 'template' => $template]);
	        }

        }else{
        	$this->load->view('admin/Email/addTemplate', ['adminDetails' => $adminDetails,'template' => $template]);
        }
