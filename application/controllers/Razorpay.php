...
class Razorpay extends CI_Controller {
    ...
    public function index() {
        ...
        $data['name']               =   $this->input->post('fname').' '.$this->input->post('fname');
        $data['email']              =   $this->input->post('email');
        $data['phone_no']           =   $this->input->post('mobile_no'); 
        $data['amount']             =   200;
        $data['work']               = '---ONE WAY TAXI---';
        $data['coupon_code']        = $this->input->post('promo_code');
    ...
    private function curl_handler($payment_id, $amount)  {
        ...
        $key_id         = "rzp_live_tdYclHE4IhM7uv";
        $key_secret     = "T5LkkTqC3Es8OxFKH64Rmb5q";
    ...
    public function success() {
        ...
        $this->load->view('cab_booking_success');
    ...
    public function failed() {
        ...
        echo "<br/>";
        echo "Order ID: ".$this->session->flashdata('merchant_order_id');
        $this->load->view('cab_booking_failed');
    }
